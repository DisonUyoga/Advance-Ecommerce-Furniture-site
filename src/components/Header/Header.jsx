    ...
    <Row>
      <div className="nav__wrapper">
...

          {
            nav__link.map((item, index)=>(
              <li key={index} className="nav__item">
                <NavLink to={item.path} className={({isActive})=>isActive?'nav_active':''} >{item.display}</NavLink>
            </li>
            ))
          }
        ...
        {/* function name does not bare literal meaning */}
         <span className="fav__icon" onClick={()=>navigateToCart("/contact")}>
        ...
        <span className="fav__icon">
          ...
          <span className="cart__icon" onClick={()=>navigateToCart("/cart")}>
